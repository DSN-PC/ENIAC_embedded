...
// =======================================================================
#define MY_DEFAULT_HOST_NAME		"WSN_BOARD"
...
#define MY_DEFAULT_MAC_BYTE6            ((BYTE)DSNPC_BOARD_ID)	// address instead.

#define MY_DEFAULT_IP_ADDR_BYTE1        (192ul)
#define MY_DEFAULT_IP_ADDR_BYTE2        (168ul)
#define MY_DEFAULT_IP_ADDR_BYTE3        (0ul)
#define MY_DEFAULT_IP_ADDR_BYTE4        (100ul + (unsigned long)DSNPC_BOARD_ID)
...
#define MY_DEFAULT_PRIMARY_DNS_BYTE4	(100ul)
 ...
 */
#define MAX_UDP_SOCKETS     (7u)        // 1 DHCP client, 1 Eniac server, 4 Eniac clients, 1 Announce
 ...
 */
#define BSD_SOCKET_COUNT (7u)   // 1 Eniac server, 4 Eniac UDP clients, 2 Eniac TCP clients
